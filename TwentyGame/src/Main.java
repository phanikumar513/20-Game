				...
				if(ti<8 && tj<7 && tii<8 && tjj<7)
				{
					if(a[ti][tj]==a[tii][tjj])
					{
						...
						if(a[ti][tj]<20 && a[tii][tjj]<20)
						{
							...
							{
								tt=0;
								System.out.println("You have to enter correct location1");
							}
						}
						else
						{
							tt=0;
							System.out.println("You have to enter correct location2");
						}
					}
					else
					{
						tt=0;
						System.out.println("You have to enter correct location3");
					}
				}
				else
				{
					tt=0;
					System.out.println("You have to enter correct location4");
				}
			}//while dir(tt=0)
